...
/*
  On fait une allocation dynamique de la classe avec i qui pointe le début de l'objet
  on affiche le contenu de l'objet
  on libere l'espace alloué 
  on refait une alloc. dynamique avec des valeurs hardcodées
  On modifie le nom
  On affiche le contenu
  on relibere l'espace alloué
*/
