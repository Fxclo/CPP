...
void Essai1()
{
  ...
  try // bloc qui peut causer une exception !
  {
    Couleur c;
  ...
  catch(const RGBException& e) // récupération de l'erreur et la valeur
  {
    cout << "Erreur : " << e.getMessage() << endl;
    cout << "Preuve : " << e.getValeur() << endl;
  }
...
void Essai2()
{
  ...
  {
    cout << "Erreur : " << e.getMessage() << endl;
    cout << "Preuve : " << e.getCoordonnee() << endl;
  }
...
void Essai3()
{
  ...
  catch(const XYException& e2)
  {
    cout << "Erreur : " << e2.getMessage() << endl;
    cout << "Preuve : " << e2.getCoordonnee() << endl;
  }
